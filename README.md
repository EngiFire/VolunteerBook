...
https://www.figma.com/file/Ieyv9tGwxKM2NWAgAs5pQJ/Untitled?type=design&node-id=0-1&mode=design&t=sPuTewsek7KU6LWM-0
...
Тест-кейс 2: Регистрация пользователя

Шаги:

   1. Нажать на кнопку "Зарегистрироваться".
   2. Заполнить анкету и подтвердить регистраци.
   3. Войти в аккаунт.
Ожидаемый результат:
   1. Уведомление о процессе расмотрения заявки на регистрацию.
   2. Пользователь успешно входит в свой аккаунт и открывается личный кабинет пользователя.


_________________________________________________________

Тест-кейс 3: Просмотр списка запланированных мероприятий

Шаги:

   1. Войти в аккаунт.
   2. Нажать на кнопку "Мои запланированные мероприятия".
Ожидаемый результат:

Пользователь видит список мероприятий, регистрацию на которые ему одобрили участие.

_________________________________________________________

Тест-кейс 4: Просмотр списка мероприятий

Шаги:

   1. Войти в аккаунт.
   2. Нажать на кнопку ![image](https://github.com/EngiFire/VolunteerBook/assets/107999830/44c9d593-5cb6-46f5-9ecd-4e866ffdd482) «Список мероприятий». в нижней панели навигации.
      
Ожидаемый результат:

   1. Пользователь видит  список мероприятий на которые он может зарегестрироваться.

_________________________________________________________

Тест-кейс 5: Создание мероприятия

Шаги:

   1. Войти в аккаунт организатора.
   2. Нажать на кнопку ![image](https://github.com/EngiFire/VolunteerBook/assets/107999830/8a89ddba-8bfd-461e-9b37-2722e697e3ae) «Организатор». в нижней панели навигации.
   3. Нажать на кнопку "Создать мероприятия".
   4. Заполнить поля на экране создания мероприятия и подтвердить добавление мероприятия.
      
Ожидаемый результат:

Отображение мероприятия в "Мои мероприятия" и "Список мероприятий"

_________________________________________________________

Тест-кейс 6: Запись на мероприятие

Шаги:

   1. Нажать на кнопку ![image](https://github.com/EngiFire/VolunteerBook/assets/107999830/44c9d593-5cb6-46f5-9ecd-4e866ffdd482) «Список мероприятий». в нижней панели навигации.
   2. Выбрать мероприятие из списка предложенных пользователю.
   3. Записаться на мероприятие
      
Ожидаемый результат:

   1. В списке мероприятий не должны отображаться укомплектованные волонтёрами мероприятия
   2. Завяка появляется в списке заявок у организатора.

_________________________________________________________

Тест-кейс 7: Приём заявки на участии в мероприятии

Шаги:

   1. Нажать на кнопку ![image](https://github.com/EngiFire/VolunteerBook/assets/107999830/1f5ad640-0937-4297-9538-665dff61eb94) «Заявки». в нижней панели навигации.
   2. Выбрать в верхнем переключателе "Заявки на мероприятия" и из предложенного списка перейти на выбранное мероприятие
   3. Добавить/отклонить участников из списка "Люди подавшие заявку"
   4. 
      
Ожидаемый результат:

   1. Добавление мероприятия в списки "Запланированные мероприятия" у участника.
   2. Увеличение счётчика количества записавшихся волонтёров.
________________________________________________________________________________________________________________________

Контактная информация
Контакты разработчика:

Волощенко А.С. - voloshchenko.alexey01@gmail.com
Гем И.Р. - gem-iv@mail.ru
